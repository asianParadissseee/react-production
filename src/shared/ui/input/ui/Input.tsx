import React, {ChangeEvent, FC, InputHTMLAttributes, memo, useEffect, useRef, useState} from 'react';
    ...
    return (
        <div className={classNames(cls.InputWrapper)}>
            ...
            <div className={cls.caretWrapper}>
                <input type={type} value={value} onFocus={onFocus} onBlur={onBlur} onSelect={onSelect}
